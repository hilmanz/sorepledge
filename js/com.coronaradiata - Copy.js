...
jQuery(
  ...
  function ($) {
	...
	$('#seccion1').bind('scroll',function(e)
	{
		...
		else if( $('#nosotros7').offset().top < $.Window.height() / 2 )
		{
			$('#menuSeccion1 li').removeClass('active');
	...
	$('#seccion2').bind('scroll',function(e)
	{
		...
		else if( $('#ilustracion12').offset().top < $.Window.height() / 2 )
		{
			$('#menuSeccion2 li').removeClass('active');
	...
	$('#seccion3').bind('scroll',function(e)
	{
		if( $('#dis2').offset().top < $.Window.height() / 2 && $('#dis3').offset().top > $.Window.height() / 2 )
		{
			...
			$('#s3-dos').addClass('active');
			cambiar( $('#s3-dos') );
		}
		else if( $('#dis3').offset().top < $.Window.height() / 2 )
		{
			$('#menuSeccion3 li').removeClass('active');
			$('#s3-tres').addClass('active');
			cambiar( $('#s3-tres') );
		}
		else
		{
			$('#menuSeccion3 li').removeClass('active');
			$('#s3-uno').addClass('active');
			cambiar( $('#s3-uno') );
		}
	});
	...
	$('#interactivo1').coinslider({width:757, height:473, links:false, navigation:true, spw: 1, sph: 1, effect:'straight', delay:3000, bgColor:'#ff7e00', bgClass:'cs-active3' });
	$('#interactivo6').coinslider({width:757, height:498, links:false, navigation:true, spw: 1, sph: 1, effect:'straight', delay:3000, bgColor:'#ff7e00', bgClass:'cs-active3' });
	$('#interactivo3').coinslider({width:757, height:437, links:false, navigation:true, spw: 1, sph: 1, effect:'straight', delay:3000, bgColor:'#ff7e00', bgClass:'cs-active3' });
	$('#interactivo4, #interactivo2').coinslider({width:757, height:505, links:false, navigation:true, spw: 1, sph: 1, effect:'straight', delay:3000, bgColor:'#ff7e00', bgClass:'cs-active3' });
	$('#interactivo5').coinslider({width:757, height:460, links:false, navigation:true, spw: 1, sph: 1, effect:'straight', delay:3000, bgColor:'#ff7e00', bgClass:'cs-active3' });
	$('#interactivo7').coinslider({width:757, height:505, links:false, navigation:true, spw: 1, sph: 1, effect:'straight', delay:3000, bgColor:'#ff7e00', bgClass:'cs-active3' });
	
	$('#diseno1').coinslider({width:757, height:450, links:false, navigation:true, spw: 1, sph: 1, effect:'straight', delay:3000, bgColor:'#00e4ff', bgClass:'cs-active4' });
	$('#diseno2').coinslider({width:757, height:377, links:false, navigation:true, spw: 1, sph: 1, effect:'straight', delay:3000, bgColor:'#00e4ff', bgClass:'cs-active4' });
